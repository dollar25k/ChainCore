 ...
 * This file demonstrates how to integrate Chaincore with a web frontend
 */

// For React/Vue/Angular applications
export class ChaincoreClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ChaincoreClient(provider, contractAddress);
